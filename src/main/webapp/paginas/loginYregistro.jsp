...
<body class="d-flex flex-column min-vh-100 m-0 p-0">
    ...
    <div id="principal" class="flex-grow-1 bg-light">
        ...
        <!-- LOGIN -->
        <form:form id="formularioLogin" class="form-signin mt-5" modelAttribute="usuario" method="POST"
        ...
        <c:if test="${exitoRegistro}">
            <div id="mensajeExitoRegistro" class="alert alert-success mt-5" role="alert">
                EL REGISTRO SE HA COMPLETADO CORRECTAMENTE <br> <a href="http://localhost:8080/loginYregistro">Volver al
                    area de
                    Login</a>
        ...
        <div id="mensajeRegistrase">
            ...
            <img id="flechaAbajo" src="recursos/Bootstrap/bootstrap-icons-1.10.4/arrow-down-circle-fill.svg"
        ...
        <div id="mensajeOcultarRegistrarse" hidden="true">
            ...
            <img id="flechaArriba" src="recursos/Bootstrap/bootstrap-icons-1.10.4/arrow-up-circle-fill.svg"
                alt="Bootstrap" width="32" height="32">

        </div>

        <form:form id="formularioRegistrarse" class="form-signin mt-5" modelAttribute="usuario" hidden="true"
            method="POST" action="insertarUsuario">

            <input type="hidden" id="registroAbierto" name="registroAbierto" value="${registroAbierto}">

            <form:hidden path="idUsuario" id="idUsuario"></form:hidden>

            <label for="inputNombreDeEmpresa">Nombre de su empresa</label>
            <form:input path="nombreEmpresa" type="text" id="inputNombreDeEmpresa" class="form-control"
            ...
            <form:input path="nifEmpresa" type="text" id="inputNifEmpresa" class="form-control" placeholder="A12345678"
            ...
            <form:input path="nombreUsuario" type="text" id="inputNombreDeUsuario" class="form-control"
                placeholder="Manuel" required="true"></form:input>
            ...
            <form:input path="telefonoUsuario" type="tel" id="inputTelefonoUsuario" class="form-control"
                placeholder="666555444" required="true"></form:input>

            <label for="inputEmailUsuario">Correo Electrónico</label>
            <form:input path="emailUsuario" type="email" id="inputEmailUsuario" class="form-control"
                placeholder="manuel@gmail.com" required="true"></form:input>
            <c:if test="${errorEmailInvalido}">
                <div class="alert alert-danger"">Correo electrónico inválido.</div>
			</c:if>

			<label for=" inputContrasenia">Contraseña</label>
                    <form:input path="contraseniaUsuario" type="password" id="inputContrasenia" class="form-control"
                        placeholder="Contraseña" required="true"></form:input>
			...
			<label for=" inputVerificarContrasenia">Vuelva a introducir su
                            contraseña</label>
                            <input name="verificarContrasenia" type="password" id="inputVerificarContrasenia"
                                class="form-control" placeholder="Vuelva a introducir la contraseña" />
                            <c:if test="${errorPasswordNoCoincide}">
                                <div class="alert alert-danger"">Las contraseñas no coinciden.</div>
			</c:if>

			<button id=" botonEnviarFormularioRegistrarse" class="btn btn-lg btn-primary btn-block" type="submit">
                                    REGISTRARSE</button>
        </form:form>
    </div>
